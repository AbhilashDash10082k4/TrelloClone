...
-- CreateEnum
CREATE TYPE "SectionTitle" AS ENUM ('UPCOMING', 'IN_PROGRESS', 'DONE');
...
CREATE TABLE "Section" (
    "id" TEXT NOT NULL,
    "title" "SectionTitle" NOT NULL DEFAULT 'UPCOMING',
    "boardId" TEXT NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "TaskMapping_userId_taskId_key" ON "TaskMapping"("userId", "taskId");
...
-- AddForeignKey
ALTER TABLE "TaskMapping" ADD CONSTRAINT "TaskMapping_taskId_fkey" FOREIGN KEY ("taskId") REFERENCES "Task"("id") ON DELETE CASCADE ON UPDATE CASCADE;
